...
export default function AdminDashboard() {
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-2xl font-semibold tracking-tight text-[#f7f8f8]">Dashboard</h1>
        <p className="mt-1 text-sm text-[#8a8f98]">Overview of your platform activity</p>
      </div>
      ...
      <div className="mt-8 grid gap-4 lg:grid-cols-2">
        <div className="rounded-lg border border-[#23252a] bg-[#0f1011] p-4">
          <h2 className="text-sm font-medium text-[#d0d6e0] mb-4">Quick Actions</h2>
          <div className="space-y-2">
            ...
            >
              <span className="text-sm text-[#f7f8f8]">Review Reports</span>
            ...
            <a
              ...
              className="flex items-center justify-between rounded-lg border border-[#23252a] bg-[#141516] px-4 py-3 hover:bg-[#18191a] transition-colors"
            >
              <span className="text-sm text-[#f7f8f8]">Manage Users</span>
            ...
            <a
              ...
              className="flex items-center justify-between rounded-lg border border-[#23252a] bg-[#141516] px-4 py-3 hover:bg-[#18191a] transition-colors"
            >
              <span className="text-sm text-[#f7f8f8]">Manage Schools</span>
              <span className="text-xs text-[#8a8f98]">
        ...
        <div className="rounded-lg border border-[#23252a] bg-[#0f1011] p-4">
          <h2 className="text-sm font-medium text-[#d0d6e0] mb-4">Content Overview</h2>
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-sm text-[#8a8f98]">Books Available</span>
              <span className="text-sm text-[#f7f8f8]">{stats.books_total - stats.books_hidden}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm text-[#8a8f98]">Book Requests Open</span>
              <span className="text-sm text-[#f7f8f8]">{stats.requests_total - stats.requests_hidden}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm text-[#8a8f98]">Notes Public</span>
              <span className="text-sm text-[#f7f8f8]">{stats.notes_total - stats.notes_hidden}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm text-[#8a8f98]">Active Classrooms</span>
